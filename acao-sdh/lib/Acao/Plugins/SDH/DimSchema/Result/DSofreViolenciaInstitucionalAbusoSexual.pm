package Acao::Plugins::SDH::DimSchema::Result::DSofreViolenciaInstitucionalAbusoSexual;
...
__PACKAGE__->table("d_sofre_violencia_institucional_abuso_sexual");
...
=head2 id_sofre_violencia_institucional_abuso_sexual
  ...
  is_auto_increment: 1
  is_nullable: 0
  sequence: 'd_sofre_violencia_institucional_abuso_sexual_id_sofre_violen78'
...
__PACKAGE__->has_many(
  ...
  {
    "foreign.id_sofre_violencia_institucional_abuso_sexual" => "self.id_sofre_violencia_institucional_abuso_sexual",
  },
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:OTFnIoAEkUcJZ+ZTu8jVLw
